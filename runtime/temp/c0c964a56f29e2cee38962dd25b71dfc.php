<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\tpblog\public/../application/admin\view\link\ins.html";i:1540180568;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form" action="?" method="post" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" value="<?php echo $linkls['name']; ?>" lay-verify="required" placeholder="请输入网站名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">链接地址</label>
            <div class="layui-input-block">
                <input type="text" name="link"  value="<?php echo $linkls['link']; ?>" lay-verify="required" placeholder="请输入链接地址" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="status" value="1" <?php echo !empty($linkls['status'])?"checked":""; ?> lay-skin="switch" lay-text="已发|未发">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">排序</label>
            <div class="layui-input-block">
                <input type="text" name="sort" value="<?php echo $linkls['sort']; ?>" required lay-verify="required" autocomplete="off" class="layui-input" style="width: 50px">
            </div>
        </div>
