<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\tpblog\public/../application/admin\view\article\edit.html";i:1540376393;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="categoryid" required lay-verify="required">
                        ...
                        <option value="<?php echo $vo['categoryid']; ?>" <?php if($vo['categoryid'] == $arti['categoryid']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?>
                            </option> <?php endforeach; endif; else: echo "" ;endif; ?> </select> </div> </div> <div class="layui-form-item">
                            <label class="layui-form-label">文章标题</label>
                            <div class="layui-input-block">
                                <input type="text" name="title" value="<?php echo $arti['title']; ?>" lay-verify="required" placeholder="请输入文章标题"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="description" value="<?php echo $arti['description']; ?>" lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <img class="a2" src="/<?php echo $arti['images']; ?>" />
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="hits" value="<?php echo $arti['hits']; ?>" required lay-verify="required" autocomplete="off"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="createdat" value="<?php echo date('Y/m/d H:i:s',$arti['createdat']); ?>" required
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="checkbox" name="status" value="1" lay-skin="switch" <?php echo !empty($arti['status'])?"checked":""; ?>
                            lay-text="已发|未发">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="sort" value="<?php echo $arti['sort']; ?>" required lay-verify="required" autocomplete="off"
                            class="layui-input" style="width: 50px">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="content" placeholder="请输入文章正文" class="layui-textarea"><?php echo $arti['content']; ?></textarea>
                    </div>
                </div>
